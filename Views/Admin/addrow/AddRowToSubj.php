...
;?>
<div class="info" ></div>
<div class="ml-2 mt-4 media d-flex align-items-center flex-column">

        <div class="mb-2  "><h3><?if ($rewRite != ''){  echo "Редактирование строки в таблице Предмет";}else{echo "Добавление строки в таблицу Предмет";}?></h3></div>
    <div class="p-1 w-50">
    <!-- <form action="/ajax/add/rowtogroup" method="POST" > -->
        <div class="m-2">
        <div class="md-form mt-2">
            <input type="text" id="subj" name="subj" class="form-control">
