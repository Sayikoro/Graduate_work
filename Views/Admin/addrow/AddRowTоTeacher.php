...
<div class="ml-2 mt-4  d-flex align-items-center flex-column">
        ...
        <div class="mb-2"><h3><?if ($rewRite != ''){  echo "Редактирование строки в таблице Преподаватель";}else{echo "Добавление строки в таблицу Преподаватель";}?></h3></div>
    <div class="p-1  w-50 ">
    <!-- <form action="/ajax/add/rowtogroup" method="POST" > -->
        <div class="m-2">
        <div class="md-form mt-2">
            <input type="text" id="teacher" name="teacher" class="form-control">
            <label for="teacher">Фамилия инициалы преподавателя</label>
        </div>
            </div>
