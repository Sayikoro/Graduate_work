...
<h3 class=''>  <p class='p-o m-0' id = 'selectdate'>Выберите корпус</p></h3>
<a href="/terminal/"> <button type="button" class="btn btn-primary btn-lg  mt-2" style="width:200px;height:50px;box-shadow: none !important;" > <b>На главную</b></button></a>
    ...
    <div  class="">
<?foreach ($CorpList as $A ) :?>

    <a href="/terminal/<?echo $select?>/<?echo $A['ИД_корпуса']?>"><button type="button" class="btn btn-primary btn-lg mt-2" style="width:330px; height:150px;box-shadow: none !important;"><h3><b><?echo $A['Наименование_корпуса']?></b></h3></button></a>
